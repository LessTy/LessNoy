...
💬 Сообщение: ${formData.message}
    ...
    try {
      await fetch(
        "https://api.telegram.org/bot8362226872:AAGd5GmxB71L6LIuU7PGHtJ8b67MeraWxBE/sendMessage",
        {
          method: "POST",
                ...
                <Card className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-2">
                        Практикумы проводятся на природе
                      </p>
                    </div>
                  </div>
                </Card>
              ...
              <div className="mt-8 space-y-6">
                <Card className="p-6 bg-primary/5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Посетите наш блог или программы для получения ответов на
                    популярные вопросы о трансформации и наших услугах.
                  </p>
                </Card>
                ...
                <Card className="p-6 bg-primary/5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Желаете узнать больше о программах перед началом? Закажите
                    бесплатную 30-минутную консультацию.
                  </p>
                </Card>
              </div>
            </div>
